return {
    ...
    keys = {
        { "<leader>ff", function() require("telescope.builtin").find_files({ hidden = true, no_ignore = true }) end, desc = "", },
        { "<leader>fg", function() require("telescope.builtin").git_files({ hidden = true }) end,                    desc = "", },
        { "<leader>fs", function() require("telescope.builtin").live_grep({ hidden = true }) end,                    desc = "", },
        { "<leader>fb", function() require("telescope.builtin").buffers({ hidden = true }) end,                      desc = "", },
        { "<leader>fh", function() require("telescope.builtin").help_tags({ hidden = true }) end,                    desc = "", },
        {
            "<leader>fws",
            function()
        ...
        { "gx", function() require("telescope.builtin").diagnostics() end },
